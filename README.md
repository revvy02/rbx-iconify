...
Upload the sheet PNGs as image assets — an asset sync tool like [Asphalt](https://github.com/jacktabscode/asphalt) automates the upload and generates the name → asset id map for you. Then wire it up:

```lua
local images = require(path.to.images) -- @generated by Asphalt

image.Image = images["ui_" .. icon.sheet]
